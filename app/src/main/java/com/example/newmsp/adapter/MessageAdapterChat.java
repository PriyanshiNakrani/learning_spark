...
public class MessageAdapterChat extends RecyclerView.Adapter<MessageAdapterChat.MyViewHolder> {
    ...
    public MessageAdapterChat(Context context, List<Chats> chatslist, String imageURL) {
