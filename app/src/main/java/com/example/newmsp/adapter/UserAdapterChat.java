...
import com.example.newmsp.ui.Chat.MessageActivityChat;
...
public class UserAdapterChat extends RecyclerView.Adapter<UserAdapterChat.MyHolder> {

    Context context;
    List<Users_Chat> userlist;
    boolean isChat;
    ...
    public UserAdapterChat(Context context, List<Users_Chat> userlist, boolean isChat) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.layoutofusers_chat, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        Users_Chat users_chat = userlist.get(position);

        friendid = users_chat.getId();


        holder.username.setText(users_chat.getUsername());
        ...
        if (Objects.equals(users_chat.getImageURL(), "default")) {
            ...
            Glide.with(context).load(users_chat.getImageURL()).into(holder.imageView);
        }


        if (isChat) {

            if (users_chat.getStatus().equals("online")) {
        ...
        if (isChat) {
            ...
            LastMessage(users_chat.getId(), holder.last_msg);
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Users_Chat users = userlist.get(getAdapterPosition());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    if (firebaseUser!=null &&  chats!=null) {
                        ...
                        if (Objects.equals(chats.getSender(), friendid) && Objects.equals(chats.getReciever(), firebaseUser.getUid()) ||
                                Objects.equals(chats.getSender(), firebaseUser.getUid()) && Objects.equals(chats.getReciever(), friendid)) {
